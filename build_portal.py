...
function goDetail(slug){switchLvl(2);setTimeout(function(){var e=document.getElementById(slug);if(e){e.scrollIntoView({behavior:'smooth',block:'start'})}},150)}
function goExample(slug){switchLvl(3);setTimeout(function(){var e=document.getElementById(slug);if(e){e.scrollIntoView({behavior:'smooth',block:'start'})}},150)}
